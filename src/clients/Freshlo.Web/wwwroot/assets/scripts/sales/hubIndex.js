...
// item serach 
$.selector_cache('#temp55').select2({
    containerCssClass: "select2-data-ajax",
    placeholder: 'Select Product',
    ajax: {
        url: '/Sale/ItemSelectHubList',
        dataType: "json",
        delay: 250,
        data: function (e) {
            return {
...
$.selector_cache('#temp55').on('change', function (e) {
    ...
    //    var quantity = $('#quantity_' + parameter).text();
    ...
    //    $('#SItemId').text(parameter);
    //    $('#SCategoryName').text($('#catName_' + parameter).text());
    //    $('#SCategoryId').text($('#cateId_' + parameter).text());
    //    $('#SItemName').text($('#SpnPluname_' + parameter).text());
    //    $('#SpnItemWeight').text($('#weightId_' + parameter).text());
    //    $('#Smeaure').text($('#measure_' + parameter).text());
    //    $('#ShiddenWeight').val($('#weightId_' + parameter).text());
    //    $('#Sprice').text(sellingprice);
    //    $('#ItemType').text(itemtype);
    //    $('#MarketPrice').text($('#Market_' + parameter).text());
    //    $('#ShdMarket').text($('#Market_' + parameter).text());
    //    $('#SearchAmount').prop('value', actualPrice);
    //    $('#NetWeightId').val($('#Netweight_' + parameter).text());
    //    $('#SearchQuantity').val(quantity).prop('disabled', true);
    //    $('#itemstock').text(itemStock);
    //    $('#SearchDiscount').val(discount);
    //    if (itemtype === "Packed") {
    ...
    //        $('#SearchQuantity').prop('disabled', true);
    //    }
    //}
